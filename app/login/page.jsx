    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="flex items-center gap-2 justify-center mb-8">
          ...
          <span className="font-display font-semibold text-xl tracking-tight">JARVIS</span>
        </div>
        <form onSubmit={handleSubmit} className="bg-panel border border-border rounded-2xl p-8 space-y-4">
          <div>
            <label className="text-xs text-textMuted uppercase tracking-wide">Login</label>
            <input
          ...
          <div>
            <label className="text-xs text-textMuted uppercase tracking-wide">Parol</label>
            <input
              type="password"
              className="mt-1 w-full bg-panelAlt border border-border rounded-lg px-3 py-2 text-sm outline-none focus:border-accent"
              value={password}
        ...
        <p className="text-center text-xs text-textMuted mt-4">Boshlang'ich: admin / admin123</p>
      </div>
    </div>
  );
}
