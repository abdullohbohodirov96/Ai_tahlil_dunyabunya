...
export async function handleUpdate(update) {
  ...
  try {
    ...
    // Xatolikni yashirmasdan, to'g'ridan-to'g'ri foydalanuvchiga yozamiz —
    // shunda admin panelga kirmasdan ham nima xato ekanini ko'rish mumkin.
    console.error("[telegram] handleUpdate xatosi:", e);
    try {
      await tgSend(msg.chat.id, `⚠️ Ichki xatolik: ${e.message}`);
    } catch {
